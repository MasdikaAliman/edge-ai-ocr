...
You will receive:
1. The original Invoice/SPBB/Receipt image.
2. OCR raw text/context extracted from the image.

Your task is to extract ONLY the fields listed below from the Invoice/SPBB/Receipt.
...
remark:
  - Labels: "Remark" "Note" "Keterangan" "Remarks" "Notes" "Note:
